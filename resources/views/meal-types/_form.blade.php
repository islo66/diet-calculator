...
<div class="grid grid-cols-12 gap-4">
    ...
    <div class="col-span-12 md:col-span-4">
        <label class="block text-sm font-medium text-gray-700 mb-1">Ordine de afisare *</label>
        <input
            type="number"
            ...
            required
        >
        <p class="mt-1 text-xs text-gray-500">Mesele se afiseaza in ordine crescatoare</p>
    </div>
    ...
    <div class="col-span-12">
        ...
        <p class="mt-1 text-xs text-gray-500">Doar tipurile active pot fi selectate pentru mese noi</p>
    </div>
</div>
