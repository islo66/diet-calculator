<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <select id="locale" name="locale" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
                <option value="ro" {{ old('locale', $user->locale ?? 'ro') === 'ro' ? 'selected' : '' }}>{{ __('app.profile.lang_ro') }}</option>
            </select>
