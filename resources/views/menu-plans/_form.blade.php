...
<div class="grid grid-cols-12 gap-4">
    ...
    <div class="col-span-12 md:col-span-6">
        <label class="block text-sm font-medium text-gray-700 mb-1">Nume Plan *</label>
        <input
            type="text"
            name="name"
    ...
    <div class="col-span-12 md:col-span-4">
        <label class="block text-sm font-medium text-gray-700 mb-1">Data sfarsit</label>
        <input
            type="date"
            name="ends_at"
    ...
    <div class="col-span-12 md:col-span-4">
        <label class="block text-sm font-medium text-gray-700 mb-1">Activ</label>
        <select
            name="is_active"
            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
        >
            <option value="1" {{ old('is_active', $menuPlan->is_active ?? true) ? 'selected' : '' }}>Da</option>
            <option value="0" {{ old('is_active', $menuPlan->is_active ?? true) ? '' : 'selected' }}>Nu</option>
        </select>
    </div>
