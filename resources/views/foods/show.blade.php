        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    ...
                    @if(!$food->is_active)
                        &middot; <span class="text-red-600">Inactiv</span>
                    @endif
                </p>
            </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('nutrients.create', ['food_id' => $food->id]) }}" class="text-indigo-600 hover:underline text-sm">
                            + Adauga
                        </a>
                    </div>
                </div>
                ...
                @if($food->nutrients->count() > 0)
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            <thead>
                            <tr class="bg-gray-50">
                                <th class="px-6 py-3 text-left font-semibold text-gray-700">Baza</th>
                                <th class="px-6 py-3 text-right font-semibold text-gray-700">Kcal</th>
                                <th class="px-6 py-3 text-right font-semibold text-gray-700">Proteine</th>
                                <th class="px-6 py-3 text-right font-semibold text-gray-700">Grasimi</th>
                                <th class="px-6 py-3 text-right font-semibold text-gray-700">Carbohidrati</th>
                                <th class="px-6 py-3 text-right font-semibold text-gray-700">Fibre</th>
                            ...
                            @foreach ($food->nutrients as $nutrient)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-right whitespace-nowrap">
                                        <a href="{{ route('nutrients.edit', $nutrient) }}" class="text-indigo-600 hover:underline">Edit</a>
                ...
                @else
                    <div class="p-8 text-center text-gray-500">
                        <p>Nicio valoare nutritionala adaugata.</p>
                        <a href="{{ route('nutrients.create', ['food_id' => $food->id]) }}" class="mt-2 inline-block text-indigo-600 hover:underline">
            ...
            @if($food->notes || $food->density_g_per_ml)
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Detalii</h3>
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        @if($food->density_g_per_ml)
                            <div>
                                <span class="text-gray-500">Densitate:</span>
            ...
            {{-- Sterge --}}
            <div class="bg-white rounded-lg shadow-sm p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-2">Zona Periculoasa</h3>
                <p class="text-sm text-gray-500 mb-4">Odata sters, alimentul nu poate fi recuperat.</p>
